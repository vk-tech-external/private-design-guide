...
![Пример схемы трёхшаговой Spine-Leaf фабрики](./assets/design_cloud_connection_spine_leaf.png){params[width=60%; printWidth=60%; noBorder=true]}
{/caption}
...
![Схема классической интеграции с КСПД](./assets/design_cloud_connection_integration.png){params[width=35%; printWidth=35%; noBorder=true]}
{/caption}
...
### {heading(Распределённый межсетевой экран на основе SDN)[id=connection_sdn_based_distributed_firewall]}
