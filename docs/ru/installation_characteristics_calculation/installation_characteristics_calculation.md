...
Для четырёх сетевых карт с пропускной способностью 25 Гбит/сек, пропускная способность сети: {formula(T \approx 0.85 * \frac {4 \ast 25 \ast 10^9}{8 \ast 2^{20}} = 10133)}. Данной пропускной способности достаточно, чтобы обрабатывать трафик массива дисков сервера.
