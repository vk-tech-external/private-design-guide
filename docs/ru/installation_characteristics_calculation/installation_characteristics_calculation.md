# {heading(Пример расчета характеристик инсталляции)[id=installation_characteristics_calculation]}
...
1. Исходя из требований к количеству серверов в кластере Ceph распределение кластеров по ЦОД будет следующим:
